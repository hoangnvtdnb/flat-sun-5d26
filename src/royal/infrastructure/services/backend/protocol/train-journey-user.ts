...
export class TrainJourneyUser {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TrainJourneyUser {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTrainJourneyUser(bb:flatbuffers.ByteBuffer, obj?:TrainJourneyUser):TrainJourneyUser {
  return (obj || new TrainJourneyUser()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTrainJourneyUser(bb:flatbuffers.ByteBuffer, obj?:TrainJourneyUser):TrainJourneyUser {
...
static startTrainJourneyUser(builder:flatbuffers.Builder) {
...
static endTrainJourneyUser(builder:flatbuffers.Builder):flatbuffers.Offset {
