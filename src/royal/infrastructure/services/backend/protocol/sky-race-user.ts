...
export class SkyRaceUser {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SkyRaceUser {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSkyRaceUser(bb:flatbuffers.ByteBuffer, obj?:SkyRaceUser):SkyRaceUser {
  return (obj || new SkyRaceUser()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSkyRaceUser(bb:flatbuffers.ByteBuffer, obj?:SkyRaceUser):SkyRaceUser {
...
static startSkyRaceUser(builder:flatbuffers.Builder) {
...
static endSkyRaceUser(builder:flatbuffers.Builder):flatbuffers.Offset {
