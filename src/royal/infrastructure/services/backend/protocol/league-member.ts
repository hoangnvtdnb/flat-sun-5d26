...
export class LeagueMember {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LeagueMember {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLeagueMember(bb:flatbuffers.ByteBuffer, obj?:LeagueMember):LeagueMember {
  return (obj || new LeagueMember()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLeagueMember(bb:flatbuffers.ByteBuffer, obj?:LeagueMember):LeagueMember {
...
static startLeagueMember(builder:flatbuffers.Builder) {
...
static addCrown(builder:flatbuffers.Builder, crown:number) {
  builder.addFieldInt32(2, crown, 0);
}

static addRewardId(builder:flatbuffers.Builder, rewardId:number) {
  builder.addFieldInt32(3, rewardId, 0);
}
...
static addLastLevelUpdateDate(builder:flatbuffers.Builder, lastLevelUpdateDate:bigint) {
  builder.addFieldInt64(7, lastLevelUpdateDate, BigInt('0'));
}
...
static endLeagueMember(builder:flatbuffers.Builder):flatbuffers.Offset {
