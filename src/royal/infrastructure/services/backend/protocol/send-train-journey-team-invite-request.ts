...
export class SendTrainJourneyTeamInviteRequest {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SendTrainJourneyTeamInviteRequest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSendTrainJourneyTeamInviteRequest(bb:flatbuffers.ByteBuffer, obj?:SendTrainJourneyTeamInviteRequest):SendTrainJourneyTeamInviteRequest {
  return (obj || new SendTrainJourneyTeamInviteRequest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSendTrainJourneyTeamInviteRequest(bb:flatbuffers.ByteBuffer, obj?:SendTrainJourneyTeamInviteRequest):SendTrainJourneyTeamInviteRequest {
...
static startSendTrainJourneyTeamInviteRequest(builder:flatbuffers.Builder) {
...
static endSendTrainJourneyTeamInviteRequest(builder:flatbuffers.Builder):flatbuffers.Offset {
