...
export class LeaderboardUserInfo {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LeaderboardUserInfo {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLeaderboardUserInfo(bb:flatbuffers.ByteBuffer, obj?:LeaderboardUserInfo):LeaderboardUserInfo {
  return (obj || new LeaderboardUserInfo()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLeaderboardUserInfo(bb:flatbuffers.ByteBuffer, obj?:LeaderboardUserInfo):LeaderboardUserInfo {
...
static startLeaderboardUserInfo(builder:flatbuffers.Builder) {
...
static addLastLevelUpdateDate(builder:flatbuffers.Builder, lastLevelUpdateDate:bigint) {
  builder.addFieldInt64(2, lastLevelUpdateDate, BigInt('0'));
}
...
static addUserId(builder:flatbuffers.Builder, userId:bigint) {
  builder.addFieldInt64(7, userId, BigInt('0'));
}
...
static addHasSpecialNameStyle(builder:flatbuffers.Builder, hasSpecialNameStyle:boolean) {
  builder.addFieldInt8(10, +hasSpecialNameStyle, +false);
}
...
static endLeaderboardUserInfo(builder:flatbuffers.Builder):flatbuffers.Offset {
