...
export class LightningRushUser {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LightningRushUser {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLightningRushUser(bb:flatbuffers.ByteBuffer, obj?:LightningRushUser):LightningRushUser {
  return (obj || new LightningRushUser()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLightningRushUser(bb:flatbuffers.ByteBuffer, obj?:LightningRushUser):LightningRushUser {
...
static startLightningRushUser(builder:flatbuffers.Builder) {
...
static endLightningRushUser(builder:flatbuffers.Builder):flatbuffers.Offset {
