...
export class TeamMemberInfo {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TeamMemberInfo {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTeamMemberInfo(bb:flatbuffers.ByteBuffer, obj?:TeamMemberInfo):TeamMemberInfo {
  return (obj || new TeamMemberInfo()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTeamMemberInfo(bb:flatbuffers.ByteBuffer, obj?:TeamMemberInfo):TeamMemberInfo {
...
lastLeagueLevelUpdateDate():bigint {
...
static startTeamMemberInfo(builder:flatbuffers.Builder) {
...
static addHelpCount(builder:flatbuffers.Builder, helpCount:number) {
  builder.addFieldInt32(3, helpCount, 0);
}
...
static addCrown(builder:flatbuffers.Builder, crown:number) {
  builder.addFieldInt32(5, crown, 0);
}

static addLastLeagueLevelUpdateDate(builder:flatbuffers.Builder, lastLeagueLevelUpdateDate:bigint) {
  builder.addFieldInt64(6, lastLeagueLevelUpdateDate, BigInt('0'));
}
...
static addWorldCupBadge(builder:flatbuffers.Builder, worldCupBadgeOffset:flatbuffers.Offset) {
  builder.addFieldOffset(8, worldCupBadgeOffset, 0);
}
...
static addKnightType(builder:flatbuffers.Builder, knightType:KnightType) {
  builder.addFieldInt8(11, knightType, KnightType.None);
}

static endTeamMemberInfo(builder:flatbuffers.Builder):flatbuffers.Offset {
