...
export class DeprecatedAuthenticateResponse {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DeprecatedAuthenticateResponse {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDeprecatedAuthenticateResponse(bb:flatbuffers.ByteBuffer, obj?:DeprecatedAuthenticateResponse):DeprecatedAuthenticateResponse {
  return (obj || new DeprecatedAuthenticateResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDeprecatedAuthenticateResponse(bb:flatbuffers.ByteBuffer, obj?:DeprecatedAuthenticateResponse):DeprecatedAuthenticateResponse {
...
static startDeprecatedAuthenticateResponse(builder:flatbuffers.Builder) {
...
static endDeprecatedAuthenticateResponse(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static createDeprecatedAuthenticateResponse(builder:flatbuffers.Builder, teamId:bigint, teamNameOffset:flatbuffers.Offset, logo:number, leader:bigint, coLeadersOffset:flatbuffers.Offset, messagesOffset:flatbuffers.Offset, askLifeRemainingTime:bigint, lifeChangesOffset:flatbuffers.Offset, teamUserCount:number, helpBanRemainingTime:bigint, joinTeamDate:bigint, royalPassClaimsOffset:flatbuffers.Offset, teamGiftOfferClaimsOffset:flatbuffers.Offset):flatbuffers.Offset {
  DeprecatedAuthenticateResponse.startDeprecatedAuthenticateResponse(builder);
  DeprecatedAuthenticateResponse.addTeamId(builder, teamId);
  DeprecatedAuthenticateResponse.addTeamName(builder, teamNameOffset);
  DeprecatedAuthenticateResponse.addLogo(builder, logo);
  DeprecatedAuthenticateResponse.addLeader(builder, leader);
  DeprecatedAuthenticateResponse.addCoLeaders(builder, coLeadersOffset);
  DeprecatedAuthenticateResponse.addMessages(builder, messagesOffset);
  DeprecatedAuthenticateResponse.addAskLifeRemainingTime(builder, askLifeRemainingTime);
  DeprecatedAuthenticateResponse.addLifeChanges(builder, lifeChangesOffset);
  DeprecatedAuthenticateResponse.addTeamUserCount(builder, teamUserCount);
  DeprecatedAuthenticateResponse.addHelpBanRemainingTime(builder, helpBanRemainingTime);
  DeprecatedAuthenticateResponse.addJoinTeamDate(builder, joinTeamDate);
  DeprecatedAuthenticateResponse.addRoyalPassClaims(builder, royalPassClaimsOffset);
  DeprecatedAuthenticateResponse.addTeamGiftOfferClaims(builder, teamGiftOfferClaimsOffset);
  return DeprecatedAuthenticateResponse.endDeprecatedAuthenticateResponse(builder);
}
}
